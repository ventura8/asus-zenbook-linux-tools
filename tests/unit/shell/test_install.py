...
class TestInstallScriptUnit(InstallTestBase):
    ...
    def test_hotkey_service_keeps_session_dbus_access(self):
        ...
        # Ordering is essential: systemd-backlight would otherwise clamp the restored level.
        self.assertIn("After=systemd-backlight@backlight:asus_screenpad.service", active_lines)
