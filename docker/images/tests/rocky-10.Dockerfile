# Keep tag rocky:10 / filename rocky-10; pin digest (Dependabot keeps floating :10).
...
# Rocky 10: no ydotool/alsa-tools/xdotool/python3-evdev RPMs in base+EPEL (same as Alma 10).
...
# python3-gobject is platform default only; bind 3.13 via poetry (evdev) + venv PyGObject.
